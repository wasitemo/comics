...
export default function PrivateBlogCreatePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://comics-2mkb.onrender.com/protected/blog/add-blog",
        {
          method: "POST",
          headers: {
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md mx-auto">
        <div className="mb-8">
          ...
          <h1 className="mt-4 text-3xl font-bold text-gray-900">Create New Blog</h1>
        </div>
